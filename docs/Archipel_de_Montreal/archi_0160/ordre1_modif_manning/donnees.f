  ...
  ! Données du terrain
  GP=9.81,
  is_override_manning=0, override_manning=0.02000,               ! nombre de manning qui override les autes si is_...=1

  ! Données du maillage
  is_cgns=1,
  meshfile_path='',
  meshfile='manning_archi_mod_4_2.cgns',                    ! Fichier de maillage
  ...
  xpoint=274956.783790834, ypoint=5043746.46205659, zpoint=5.93 ! Point appartenant au plan
  ...
  debitglob=10.,142.,858.,10300.,16.5,96.,10.                             ! Débit aux entrées, séparer les débits pas des ,
  outlet_name="Outflow nodes"
  H_sortie=5.93,                                                 ! Hauteur du niveau à la sortie du domaine
  ...
  TS=40000., CFL=0.6,                                             ! Temps maximal de simultion, nombre CFL
