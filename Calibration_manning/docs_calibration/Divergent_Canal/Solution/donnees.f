&DONNEES_NAMELIST 
  ...
  ! Données du terrain
  GP=9.81,
  is_override_manning=0, override_manning=0.00,               ! nombre de manning qui override les autes si is_...=1

  ! Données du maillage
  is_cgns=1,
  meshfile_path='./',
 ! meshfile='manning_DivCanal_mesh_416_1_Case_156.cgns',                    ! Fichier de maillage
  meshfile='manning_Canal_divergent.cgns',
  ...
  x1eqbar=0.010001, x2eqbar=0.0100,         ! Abscisses des deux points du barrage
  y1eqbar=0.000, y2eqbar=1.0000,          ! Ordonnées des deux points du barrage
  H_AMONT=0.001, U_AMONT=0, V_AMONT=0,                            ! Valeur de l'init du coté - de la normale au barrage
  H_AVAL=0.02, U_AVAL =0, V_AVAL =0,                            ! Valeur de l'init du coté + de la normale au barrage
  ...
  xpoint=10.00, ypoint=0.75, zpoint=0.016 ! Point appartenant au plan
  ...
  debitglob=0.50,                                               ! Débit aux entrées, séparer les débits pas des ,
  outlet="fixedheight",
  outlet_name="Outflow nodes",
  H_sortie=0.2,                                                 ! Hauteur du niveau à la sortie du domaine
  ...
  TS=280.0, CFL=0.9,                                             ! Temps maximal de simultion, nombre CFL
