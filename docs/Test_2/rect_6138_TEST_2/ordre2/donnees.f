  ...
  H_AMONT=0.51, U_AMONT=2.5, V_AMONT=0,                            ! Valeur de l'init du coté - de la normale au barrage
  H_AVAL=0.48, U_AVAL =-5.8, V_AVAL =0,                            ! Valeur de l'init du coté + de la normale au barrage
  ...
  TS=1., CFL=0.9,                                             ! Temps maximal de simultion, nombre CFL
