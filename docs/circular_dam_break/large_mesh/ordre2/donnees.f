  ...
  is_cgns=1,
  meshfile_path='',
  meshfile='mesh_947939.cgns',                    ! Fichier de maillage
  ...
  fich_sol_init='sol_init_circmesh_947939.cgns.txt',      ! nom du fichier d'initialisation
  ...
  IFLUX=4, ilimiteur=3, iupwind=1,                               ! 1 -> HLLC , 2 -> WAF Riadh, 3 -> WAF Loukili
  tolisec=1.0E-05,                                               ! Tolérence sec/mouillé
  friction=0,                                                    ! 1 pour prendre en compte la friction
  fricimplic=1,                                                  ! 0 -> explicite, 1 -> I-dt/2*J, 2 -> I-dt*B

  TS=4., CFL=0.9,                                             ! Temps maximal de simultion, nombre CFL
  ...
  sol_z_offset=0.
  solrestart=0,                            ! Sauvegarde en overwrite la solution pour restart
  solvisu=3, visu_snapshots=40,                         ! 1 all, 2 vtk, 3 cgns, 4 simple nodes, 5 simple elems
