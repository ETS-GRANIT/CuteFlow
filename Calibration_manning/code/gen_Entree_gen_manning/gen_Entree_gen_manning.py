#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#		FICHIER D'ENTRÉE AU CODE D'ASSIGNATION DES COEFFICIENTS  MANNINGS AUX CELLULES DU MAILLAGE
...
# Extraction des données de la colonne 1 (cellIDs) et 2 (manningValues)
cellIDs = [int(sheet.cell(row=i, column=2).value) for i in range(2, sheet.max_row + 1)]
