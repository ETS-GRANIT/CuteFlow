...
# INPUTS
    ...
    ## space = calculRange(cv, z, [n1,n2,n3,n4])
# OUTPUTS
...
space = calculRange(0.05, 1.96, [0.022, 0.024, 0.025, 0.017])

# Configuration de l'échantillonnage QMC : Paramètres d'entrée
n_variables = len(space[0])
m_échantillons = 4    # Le nombre d'échantillons est n_variables = 2**m_echantillons.
