&DONNEES_NAMELIST 
  ...
  ! Données du terrain
  GP=9.81,
  is_override_manning=1, override_manning=0.02,               ! nombre de manning qui override les autes si is_...=1
  ...
  H_AMONT=800, U_AMONT=0, V_AMONT=0,                            ! Valeur de l'init du coté - de la normale au barrage
  H_AVAL =30.1, U_AVAL =0, V_AVAL =0,                             ! Valeur de l'init du coté + de la normale au barrage
  ...
  H_sortie=29.1,                                                  ! Hauteur du niveau à la sortie du domaine
  ...
  TS=100.0, CFL=0.6,                                              ! Temps maximal de simultion, nombre CFL
