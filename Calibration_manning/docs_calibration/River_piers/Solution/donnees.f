&DONNEES_NAMELIST 
  ...
  is_cgns=1,
  meshfile_path='./',
 ! meshfile='manning_DivCanal_mesh_416_1_Case_256.cgns',                    ! Fichier de maillage
  ...
  H_AMONT=0.0001, U_AMONT=0, V_AMONT=0,                            ! Valeur de l'init du coté - de la normale au barrage
