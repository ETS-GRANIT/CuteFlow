&DONNEES_NAMELIST 
  ...
  ! Données du terrain
  GP=9.81,
  is_override_manning=1, override_manning=0.01,               ! nombre de manning qui override les autes si is_...=1

  ! Données du maillage
  is_cgns=1,
  meshfile_path='./',
 ! meshfile='manning_DivCanal_mesh_416_1_Case_2.cgns',                    ! Fichier de maillage
  ...
  H_AVAL=0.00, U_AVAL =0, V_AVAL =0,                            ! Valeur de l'init du coté + de la normale au barrage
  ...
  debitglob=0.350,                                               ! Débit aux entrées, séparer les débits pas des ,
  outlet="fixedheight",
