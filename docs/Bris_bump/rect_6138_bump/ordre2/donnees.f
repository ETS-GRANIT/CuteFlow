  ...
  is_cgns=1,
  meshfile_path='',
  meshfile='mesh_6138_bump.cgns',                    ! Fichier de maillage
  ...
  x1eqbar=4.0001, x2eqbar=4.,         ! Abscisses des deux points du barrage
  ...
  H_AVAL=0.1, U_AVAL =0, V_AVAL =0,                            ! Valeur de l'init du coté + de la normale au barrage
  ...
  TS=10., CFL=0.9,                                             ! Temps maximal de simultion, nombre CFL
