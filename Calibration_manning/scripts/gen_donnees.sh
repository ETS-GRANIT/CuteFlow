echo "&DONNEES_NAMELIST 
  ...
  is_cgns=1,
  meshfile_path='./',
  meshfile='manning_mesh_4640_1_Case_$4.cgns',                    ! Fichier de maillage
  ...
  x1eqbar=3.0001, x2eqbar=3.0000,         ! Abscisses des deux points du barrage
  y1eqbar=2.000, y2eqbar=0.0000,          ! Ordonnées des deux points du barrage
  ...
  inlet_name='Inflow nodes 0',
  debitglob=$1,                                               ! Débit aux entrées, séparer les débits pas des ,
  outlet_name='Outflow nodes 0',
  H_sortie=$3,                                                 ! Hauteur du niveau à la sortie du domaine
  ...
  solvisu=3, visu_snapshots=10,                                  ! 1 all, 2 vtk, 3 cgns, 4 simple nodes, 5 simple elems
