module global_data
  ...
  real(fp_kind), allocatable :: dt, dt_max 
  ...
  !real(fp_kind), dimension(200000)             :: tvis3d2 , tvis2d2, tsoljauge, tsolrestart, tsolvisu
  ...
  integer, dimension(:,:),   allocatable :: connectivite, ij_wet_dry, ij_dry_wet, nds_coupes, vertex_neighbors
  ...
  real(fp_kind), dimension(:,:), allocatable :: vdlg, vdlg0, vdlg_nodes, vdlg_visu, vdlg_visu_nodes
  ...
  real(fp_kind), dimension(:,:), allocatable :: resc, res
  real(fp_kind), dimension(:,:),   allocatable :: afm1, sourcfric, sourcbath
  integer, dimension(:,:,:), allocatable :: upwind_cells

  integer, dimension(:), allocatable :: elt_fant_envoi_length
  integer, dimension(:,:), allocatable :: elt_fant_envoi_id
  real(fp_kind), dimension(:,:,:), allocatable :: elt_fant_envoi_sol
